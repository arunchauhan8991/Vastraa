    ...
    <div className="w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] overflow-x-hidden text-[white] relative ">
      ...
      <div className="w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute right-0 bottom-[5%] ">
        ...
        >
          ...
          <div className="w-[80%] h-[130px] flex items-start justify-center flex-col mt-5 gap-[10px] ">
            ...
            <div className="w-[100%] h-[100%] flex items-center justify-start ">
              ...
              >
                <img
                  src={!image1 ? uploadLogo : URL.createObjectURL(image1)}
                  alt="product image"
              ...
              >
                <img
                  src={!image2 ? uploadLogo : URL.createObjectURL(image2)}
                  alt="product image"
                  className="w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px] "
                />
                <input
              ...
              >
                <img
                  src={!image3 ? uploadLogo : URL.createObjectURL(image3)}
                  alt="product image"
                  className="w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px] "
                />
                <input
              ...
              >
                <img
                  src={!image4 ? uploadLogo : URL.createObjectURL(image4)}
                  alt="product image"
                  className="w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-[2px] "
                />
                <input
          ...
          <div className="w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px] ">
            ...
            <input
              type="text"
              placeholder="Name"
              className="w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-text
            bg-slate-600 px-5 text-[18px] placeholder:text-[#ffffffc2] "
          ...
          <div className="w-[80%] flex items-start justify-center flex-col gap-[10px] ">
            ...
            <textarea
              ...
              className="w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-text
            bg-slate-600 px-5 text-[18px] placeholder:text-[#ffffffc2] py-[10px] "
          ...
          <div className="w-[80%] flex items-center gap-[10px] flex-wrap ">
            <div className="md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px] ">
              <p className="text-xl md:text-2xl font-semibold w-[100%] ">
                Product Category
              </p>
              <select
                name=""
