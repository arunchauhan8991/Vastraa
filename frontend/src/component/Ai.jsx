...
function Ai() {
  ...
  return (
    ...
    onClick={()=>{recognition.start()
        ...
        <img src={ai} alt="" className={`w-[75px] cursor-pointer ${activeAi ? 'translate-x-[10%] translate-y-[-10%] scale-125 ' : 'translate-x-[0] translate-y-[0] scale-100'} transition-transform` } style={{
