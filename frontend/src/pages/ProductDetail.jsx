...
function ProductDetail() {
  ...
  return productData ? (
    <div>
      <div className=" w-[99vw] h-[130vh] md:h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start 
      flex-col lg:flex-row gap-[20px]">
        <div className="lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex items-center justify-center md:gap-[10px] gap-[30px] 
        flex-col-reverse lg:flex-row">
          ...
          <div className="lg:w-[60%] w-[80%] lg:h-[78%] h-[70%] border-[1px] border-[#80808049] rounded-md  overflow-hidden">
            <img
              src={image}
              alt=""
              className=" w-[100%] lg:h-[100%] h-[100%] text-[30px] text-white  text-center rounded-md object-contain "
            />
          </div>
        </div>
        ...
        px-[30px]
         md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]">
          ...
          <p className=" w-[80%] md:w-[60%] text-[20px] font-semibold pl-[5px] text-[white]">
            {productData.description} and Stylish, breathable Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem, facere at est 
            accusantium magnam ea. Illo consectetur laboriosam nemo eum maiores rem clothing.
            </p>
      ...
      <div className="w-[100%] min-h-[70vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col 
       overflow-x-hidden">
        ...
        <div className="w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] 
        px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px]">
          <p className="w-[95%] h-[90%] flex items-center justify-center ">
            Upgrade your wardrobe with this stylish Lorem ipsum dolor sit 
            amet consectetur adipisicing elit. Ipsa, beatae doloremque pariatur 
            laudantium quidem debitis libero non officiis commodi dolor eum perspiciatis 
            numquam consequatur officia quas asperiores maxime  is a must-have
